...
function calculateNetSalary(basicSalary, benefits) {
  ...
  // Example Usage
  const salaryDetails = calculateNetSalary(80000, 5000); // Basic salary = KShs 80,000, Benefits = KShs 5,000
  
  console.log("Gross Salary: KShs " + salaryDetails.grossSalary);
  console.log("PAYE: KShs " + salaryDetails.payee);
  console.log("SHIF Deduction: KShs " + salaryDetails.shifDeduction);
  console.log("NSSF Employee Contribution: KShs " + salaryDetails.nssfEmployeeContribution);
  console.log("Affordable Housing Levy: KShs " + salaryDetails.housingLevy);
  console.log("Total Deductions: KShs " + salaryDetails.totalDeductions);
  console.log("Net Salary: KShs " + salaryDetails.netSalary);
